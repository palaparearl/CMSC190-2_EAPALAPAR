...
//										maze.reset();
										if(percent >= 0.55) {
											...
											else if(maze.getLevel() == 6) {
												maze.reset();
												State.setState(handler.getGame().thirdCoding);
												State.getState().setUIManager();
											}
											else if(maze.getLevel() == 9) {
												maze.reset();
				...
				switch(i) {
					case 0:
						if(answer == 0) {
							...
							g.drawImage(Assets.darkChoices[maze.getLevel() - 1][roomNo][0], 205, 415, null);
						}
						
						if(correctAnswer == 0) {
							g.drawImage(Assets.check, 205 + 400 - 7, 407, null);
						}
						else {
							g.drawImage(Assets.cross, 205 + 400 - 7, 407, null);
						}
					...
					case 1:
						if(answer == 1) {
							...
							g.drawImage(Assets.darkChoices[maze.getLevel() - 1][roomNo][1], 205, 475, null);
						}
						
						if(correctAnswer == 1) {
							g.drawImage(Assets.check, 205 + 400 - 7, 467, null);
						}
						else {
							g.drawImage(Assets.cross, 205 + 400 - 7, 467, null);
						}
					...
					case 2:
						if(answer == 2) {
							...
							g.drawImage(Assets.darkChoices[maze.getLevel() - 1][roomNo][2], 205, 535, null);
						}
						
						if(correctAnswer == 2) {
							g.drawImage(Assets.check, 205 + 400 - 7, 527, null);
						}
						else {
							g.drawImage(Assets.cross, 205 + 400 - 7, 527, null);
						}
