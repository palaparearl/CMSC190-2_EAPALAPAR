...
public class Assets {
	...
	public static Font filmCryptic, font28, font50, arial, arial40, courier, trixie, garamonditalic, garamondbold, garamondbold2, sevensegment, p22_typewriter, monospace;
...
//	public static BufferedImage[] nxt_lvl;
	...
	public static BufferedImage[][][] darkChoices;
	...
	public static void init() {
		...
		levelsLocked[0] = levelsLockedSheet.crop(0, 0, 290, 55);
		levelsLocked[1] = levelsLockedSheet.crop(0, 55, 290, 55);
		levelsLocked[2] = levelsLockedSheet.crop(0, 55 * 2, 290, 55);
		levelsLocked[3] = levelsLockedSheet.crop(0, 55 * 3, 290, 55);
		levelsLocked[4] = levelsLockedSheet.crop(0, 55 * 4, 290, 55);
		levelsLocked[5] = levelsLockedSheet.crop(290, 0, 290, 55);
		levelsLocked[6] = levelsLockedSheet.crop(290, 55, 290, 55);
		levelsLocked[7] = levelsLockedSheet.crop(290, 55 * 2, 290, 55);
		levelsLocked[8] = levelsLockedSheet.crop(290, 55 * 3, 290, 55);
		levelsLocked[9] = levelsLockedSheet.crop(290, 55 * 4, 290, 55);
		
		levels = new BufferedImage[10][2];
		
		levels[0][0] = levelsUnselected.crop(0, 0, 290, 55);
		levels[1][0] = levelsUnselected.crop(0, 55, 290, 55);
		levels[2][0] = levelsUnselected.crop(0, 55 * 2, 290, 55);
		levels[3][0] = levelsUnselected.crop(0, 55 * 3, 290, 55);
		levels[4][0] = levelsUnselected.crop(0, 55 * 4, 290, 55);
		levels[5][0] = levelsUnselected.crop(290, 0, 290, 55);
		levels[6][0] = levelsUnselected.crop(290, 55, 290, 55);
		levels[7][0] = levelsUnselected.crop(290, 55 * 2, 290, 55);
		levels[8][0] = levelsUnselected.crop(290, 55 * 3, 290, 55);
		levels[9][0] = levelsUnselected.crop(290, 55 * 4, 290, 55);
		
		levels[0][1] = levelsSelected.crop(0, 0, 290, 55);
		levels[1][1] = levelsSelected.crop(0, 55, 290, 55);
		levels[2][1] = levelsSelected.crop(0, 55 * 2, 290, 55);
		levels[3][1] = levelsSelected.crop(0, 55 * 3, 290, 55);
		levels[4][1] = levelsSelected.crop(0, 55 * 4, 290, 55);
		levels[5][1] = levelsSelected.crop(290, 0, 290, 55);
		levels[6][1] = levelsSelected.crop(290, 55, 290, 55);
		levels[7][1] = levelsSelected.crop(290, 55 * 2, 290, 55);
		levels[8][1] = levelsSelected.crop(290, 55 * 3, 290, 55);
		levels[9][1] = levelsSelected.crop(290, 55 * 4, 290, 55);
...
//		nxt_lvl[1] = menuSheet.crop(width * 3, height * 6, width * 3, height * 2);
		...
		darkChoices = new BufferedImage[10][9][3];
		for(int i = 0; i < 10; i++) {
			for(int j = 0; j < 9; j++) {
				for(int k = 0; k < 3; k++) {
					if(choices[i][j][k][0] != null) {
						darkChoices[i][j][k] = changeBrightness(choices[i][j][k][0], 0.5f);
					}
				}
			}
		}
...
//		}
		...
		tutorialSlides = new BufferedImage[7];
		for(int i = 0; i < 7; i++) {
		...
		garamondbold2 = FontLoader.loadFont("/fonts/garamondbold.otf", 30);
